...
**Widening the scan costs nothing that can be felt.** The recs root holds 17 `*.json` files, 1,690,831 bytes, parsed in **14 ms**; seven are recommendation records and ten are not.
