...
3. #816's *Done when* had inherited defect 1 as an **unsatisfiable acceptance criterion** — *"the three declared-limit rows are in walked objects"* — which no builder could meet without creating the fourth naming convention the ruling one paragraph earlier forbids. Corrected in place on #816 under [#436](https://github.com/mshamblin5150-code/clinical-skills/issues/436)'s rule that a correction below the advice is not a correction for anyone who acts on the advice.
