...
| A citation missing first-author initials when listed first authors share a surname but differ in initials | add the entry's complete first-author initials, [apa7.md](../_shared/reference/apa7.md) §5 |
