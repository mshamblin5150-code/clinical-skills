...
**None of this settles what a named allergen's *reaction* reads**, which is [#94](https://github.com/mshamblin5150-code/clinical-skills/issues/94)'s and is open. #96 decides which allergens reach the box and how each is labeled; #94 decides what the box says where the shorthand names an allergen and no reaction. The two were one ticket and were split because either can be settled without the other.
