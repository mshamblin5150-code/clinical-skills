...
DECLARED_SECTIONS = {
    ...
    "peer_critique_scan": "Peer critique grading",
    "deck_render": "Course assignment artifact grading",
    "deck_scan": "Course assignment artifact grading",
    ...
    "install_grilling_guard": "Grilling guard",
    "install_run_status_guard": "Approved run status guard",
    ...
    "run_status_stop_hook": "Approved run status guard",
