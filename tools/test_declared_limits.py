...
NO_LIMITS = {
    ...
    "tracker_publish_marker": "a date-only record adapter whose limits belong to tracker_publish_hook",
...
NOT_LIMITS = {
    ...
    "tracker_coordinates.NOT_SCANNED_LIMBS": "the exhaustive exit-status contract, not clean-run limits",
