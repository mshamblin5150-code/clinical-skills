...
**The writer's Markdown subset is small on purpose**, and the one rule in it that is not cosmetic is that a heading beginning `References` switches every following paragraph to a 0.5 inch hanging indent. That is APA 7, the rubric gives APA format 5 of 100 points, and it is the whole of what that line can be given mechanically. Page setup is Times New Roman 12 pt, double spaced, one inch margins.
