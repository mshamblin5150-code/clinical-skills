...
**This row's own figures moved and its direction did not.** The tobacco share barely shifted — 14 of 15 on the fixtures against 172 of 197 on the corpus, 93% against 87% — which is what #78 predicted for it. What moved is the comparison it is drawn against, and **not by as much as the arithmetic makes it look**: the fixture floor set 11 of 16 allergy clauses saying nothing against 1 of 15 tobacco clauses denying it, and the corpus sets 195 of 284 naming no drug allergen against 25 of 197 denying tobacco. Both allergy shares round to 69%, which is a coincidence of two different measurements and not a figure that survived. The gap between the slots narrowed from 69-against-7 to 69-against-13 and the slots still land as far apart as the ruling needs.
